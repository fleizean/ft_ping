...
int resolve_hostname(t_ping *ping); // İmza düzeltildi
int create_socket(t_ping *ping);
int get_interface_info(t_ping *ping);
int get_gateway(t_ping *ping);
int get_gateway_mac(t_ping *ping); // Fonksiyon eklendi
int get_network_gateway_mac_address(t_ping *ping);
void start_ping(t_ping *ping); // Fonksiyonun dönüş tipi düzeltildi
void signal_handler(int sig);
void help_message(void); // Fonksiyon bildirimi eklendi
